...
int main(void)
{
    ...
    printf("\n");
    printf("Hit enter when you're done choosing! \n");
    ...
    while (true)
    {
        ...
        item[0] = toupper(item[0]); // This makes it so if the user inputs any word in lowercase, it converts the first to
                                    // uppercase. This is done so it matches the strings in the menu array.
        total += get_cost(item);
    }
